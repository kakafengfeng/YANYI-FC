      ...
      <div className="container mx-auto px-6">
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-2xl flex flex-col md:flex-row">
          <div className="p-8 md:w-1/3 text-club-navy">
             ...
             <p className="mb-4">123 ZHUDUN ROAD, FENGXIAN, SHANGHAI.</p>
          ...
          <div className="md:w-2/3 h-64 md:h-auto bg-gray-200 relative">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d19864.62353953985!2d-0.12775829999999998!3d51.5073509!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48761b3344342525%3A0xa161353e4b3e40e2!2sLondon%2C%20UK!5e0!3m2!1sen!2sus!4v1697555555555!5m2!1sen!2sus" 
              width="100%" 
              height="100%" 
              style={{border:0}} 
              allowFullScreen 
